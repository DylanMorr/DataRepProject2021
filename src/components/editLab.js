...
class EditLab extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:4000/api/labs/' + this.props.match.params.id)
            // create a promise
            .then((response) => {
                // set state
                this.setState({
    ...
    submitLab(e) {
        // alert user the lab was edited
        alert("Lab Edited!");
        // change the window location to the labs-page
        window.location = 'http://localhost:4000/labs-page';
        // log to console lab edited
        console.log("Lab Edited!");

        // create a editLab object to send data to server
        const editLab = {
        ...
        axios.put('http://localhost:4000/api/labs/' + this.state._id, editLab)
            // create a promise
            .then((response) => {
                // log response
        ...
        return (
            ...
            <div className="App">
                ...
                <form onSubmit={this.submitLab}>
                    ...
                    {/* Scan or Lab Div */}
                    <div className="form-group">
                        <label>Edit Scan or Lab Type: </label>
                        {/* select control */}
