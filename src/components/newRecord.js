...
class NewRecord extends Component {
    ...
    submitRecord(e) {
        ...
        // create a newRec object to send data to server
        const newRec = {
        ...
        // use axios to post data using newRec object
        axios.post('http://localhost:4000/api/records', newRec)
        ...
        return (
            ...
            <div className="App">
                ...
                <form onSubmit={this.submitRecord}>
                    {/* Form Title */}
                    <h4>⚕ Enter Patient Details Below ⚕</h4>
                    ...
                    <div className="form-group">
                        <label>Emergency Contact Name + Num: </label>
                        {/* Text Input Control */}
                        <input type="text"
                            className="form-control"
                            /* make required so user has to fill in out */
                    ...
                    {/* Medical Cons Div */}
                    <div className="form-group">
                        <label>Enter Any Medical Conditions: </label>
                        {/* textarea text Control */}
                        <textarea type="text"
                            className="form-control"
                            /* make required so user has to fill in out */
                    ...
                    {/* Current Meds Div */}
                    <div className="form-group">
                        <label>Enter Any Current Medications: </label>
                        {/* textarea text Control */}
                        <textarea type="text"
                            className="form-control"
                            /* make required so user has to fill in out */
